...
int main()
{
	...
	while ( letra != ')' ){
		...
		//Conta o símbolo "{" para saber o ponto de "ignição" para a leitura de um novo conjunto
		if (letra == '{'){
			cont++;
				...
				case 1:
					while ( letra != '}' ){
						...
						if ( letra >= 'a' && letra <= 'z' || letra >= '0' && letra <= '9' ){
							// Se o retorno for 1 significa que já existe um elemento
							// de mesma letra na estrutura, logo, a letra atual é repetida.
							// Assim o main informa que a letra é repetida e encerra o main,
							//caso contrário, enfileira a letra na estrutura "alf"
